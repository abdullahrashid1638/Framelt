...
const Photo = ({
    ...
    return (
        <div className={`bg-[#d9d9d9] w-1/4 h-[${img.height}] rounded-md relative overflow-hidden`}>
            <div id='image' className='bg-cover w-full'>
                <img src={imageUrl} alt={imageSlug} className='bg-cover' />
            </div>

            <div
                id="image-interaction"
                className="bg-[#638F85] w-full h-[70px] absolute bottom-0 rounded-b-md flex items-center justify-between px-4"
            >
                <div id="user" className="flex items-center">
                    <div
                        id="user-profile"
                        className="h-8 w-8 bg-white rounded-[50%] mr-2 overflow-hidden"
                    >
                        <img src={userImage} alt={userName} className='bg-cover'/>
                    </div>
                    <div
                        id="user-name"
                        className="text-[#d9d9d9] font-semibold text-sm"
                    >
                        {userName}
                    </div>
                </div>
                ...
                <button 
                    id="download-button"
                    className="bg-[#8c8c69] text-white text-[12px] py-1.5 px-8 rounded-md"
                >
                    Download
                </button>
            </div>
