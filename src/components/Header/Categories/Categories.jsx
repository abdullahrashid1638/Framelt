                ...
                <div className="flex space-x-4">
                    <a
                        ...
                        className={`relative pb-1 ${
                            lookingFor === 'Pictures' ? 'text-white' : 'text-gray-400'
                        }`}
                    ...
                    >
                        ...
                        {lookingFor === 'Pictures' && (
                            <span
                                className="absolute left-1/2 transform -translate-x-1/2 bottom-0 h-[3px] w-[18px] bg-white rounded-full"></span>
                        )}
                    </a>
                    <a
                        href="#"
                        className={`relative pb-1 ${
                            lookingFor === 'Illustrations' ? 'text-white' : 'text-gray-400'
                        }`}
